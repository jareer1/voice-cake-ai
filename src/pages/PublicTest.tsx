...
export default function PublicTest() {
  ...
  return (
    <div className="h-screen w-screen bg-white overflow-hidden flex relative">
      ...
      <div className="w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden flex items-center justify-center">
        {/* Background Elements */}
          ...
          <div className="flex justify-center mb-8">
            <div className="relative">
              <Avatar className="w-32 h-32 ring-4 ring-white/30 shadow-2xl">
                ...
                <AvatarFallback className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white text-3xl font-bold">
                  AI
                </AvatarFallback>
              </Avatar>
        ...
        <div className="flex-1 p-6 space-y-6 overflow-y-auto">
          ...
          <div className="bg-gradient-to-r from-slate-50 to-slate-100 border border-slate-200 rounded-lg p-6 text-center">
            ...
            <div className="flex gap-3 justify-center">
              <Button 
                className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 hover:shadow-lg text-white font-semibold px-6 py-2"
              >
                Get Started Free
              </Button>
              <Button 
